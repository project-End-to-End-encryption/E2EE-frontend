        ...
        >
            <div style={{ maxWidth: 1200, margin: "0 auto" }} className="px-6">
                ...
                <p
                    ...
                    className="mt-6 max-w-xl"
                >
                    Privacy isn't a setting you turn on — it's how E2EE is built, from
                    the moment a message leaves your device to the moment it lands.
                </p>
    ...
    return (
        <section id="about-us" style={{ background: COLORS.paper }} className="py-24">
            <div style={{ maxWidth: 1200, margin: "0 auto" }} className="px-6">
                ...
                <p
                    style={{ color: COLORS.obsidian, fontFamily: DISPLAY_FONT, fontSize: 16, lineHeight: 1.5 }}
                    className="mt-6 max-w-xl"
                >
                    We're a small team building private, honest messaging. Here's who's
                    behind it, and how to reach us.
                </p>
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
                        {CREDITS.map((person) => (
                            ...
                            >
                                ...
                                <p style={{ color: COLORS.obsidian, fontFamily: DISPLAY_FONT }} className="mt-1 text-sm opacity-80">
                                    {person.role}
                                </p>
                            </div>
                        ))}
                ...
                <div id="contact-us" className="mt-20 scroll-mt-24">
                    ...
                    <p
                        style={{ color: COLORS.obsidian, fontFamily: DISPLAY_FONT, lineHeight: 1.5 }}
                    ...
                    <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                        <a
                            href="mailto:hello@e2ee.example"
                            className={baseBtnClasses("sm")}
                            style={{ background: COLORS.obsidian, color: COLORS.paper, fontFamily: DISPLAY_FONT }}
                        >
                            Email us
                        </a>
                        ...
                        <a
                            ...
                            className={baseBtnClasses("sm")}
                            style={{ background: "transparent", color: COLORS.obsidian, border: `1px solid ${COLORS.obsidian}`, fontFamily: DISPLAY_FONT }}
                        >
                            Report an issue
                        </a>
                    </div>
