...
/* ─── DESIGN TOKENS ─── */
// Importing from the centralized theme and re-exporting to maintain backward
// compatibility for any older files still importing them directly from the sidepanel.
import { COLORS, DISPLAY_FONT, CAPTION_FONT } from "../../../shared/constants/theme";
export { COLORS, DISPLAY_FONT, CAPTION_FONT };

/* ═══════════════════════════════════════════════════════════════════
   SIGNAL NETWORK — ambient background animation
   ═══════════════════════════════════════════════════════════════════ */
...
function GlobalAuthStyles() {
    return (
      ...
      /* Included both cases to prevent styling issues across different files */
      .e2ee-login-input:focus, .E2EE-login-input:focus {
        outline: none;
        border-color: ${COLORS.signal} !important;
        box-shadow: 0 0 0 1px ${COLORS.signal};
      }
    `}</style>
    );
}
